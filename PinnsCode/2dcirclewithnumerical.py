...
df.to_csv("solution_outputs_circularNum/training_loss_circularNum.csv", index=False, header=False)
...
for t in plot_Time:  # Loop over the time steps
    ...
    pd.DataFrame(Z_plot).to_csv(f"solution_outputs_circularNum/height_circularNum_t{t:.2f}.csv", index=False, header=False)
