# -*- coding: utf-8 -*-
"""2Dcirclewithnumerical.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1imB70D9zOJKwNyr9FlPPRvzi5VRfYUuQ
"""
...
time_numerical = np.linspace(0.0, 0.6, 7)  # Available time steps: [0, 0.1, 0.2, 0.3]
...
IC_h = dde.IC(geomtime, func_IC_h, lambda x, _: x[2] <= 0.6, component=0)  # Match t=0
IC_u = dde.IC(geomtime, func_IC_u, lambda x, _: x[2] <= 0.6, component=1)
IC_v = dde.IC(geomtime, func_IC_v, lambda x, _: x[2] <= 0.6, component=2)

BC_u1 = dde.DirichletBC(geomtime, func_BC_all, lambda x, on_boundary: np.isclose(x[0], X_min), component=1)
BC_u2 = dde.DirichletBC(geomtime, func_BC_all, lambda x, on_boundary: np.isclose(x[0], X_max), component=1)
BC_v1 = dde.DirichletBC(geomtime, func_BC_all, lambda x, on_boundary: np.isclose(x[1], Y_min), component=2)
BC_v2 = dde.DirichletBC(geomtime, func_BC_all, lambda x, on_boundary: np.isclose(x[1], Y_max), component=2)
...
plot_Time = np.linspace(0.0, Time, 3001)
